...
<head>
    ...
    <script>
        ...
        {
            window.open("http://www.clickteam.com/html5/html5-error.html", "_self");
        }
    </script>
    ...
    <script src="/../../fusion/skydump-survival/src/Runtime.js"></script>
...
<div>
    <div style="position:absolute; top:0px; left:0px; -webkit-user-select: none;">
        <canvas id="MMFCanvas" width="960" height="540">
...
<script>
    ...
    function windowLoaded()
    {
        ...
        new Runtime("MMFCanvas", "/../../fusion/skydump-survival/resources/skydump-survival.cch");
    }
    // RUNTIMESTARTEND
</script>
